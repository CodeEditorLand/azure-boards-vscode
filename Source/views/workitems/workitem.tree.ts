...
import type { WorkItemComposite } from "./workitem";
	...
	implements vscode.TreeDataProvider<TreeNodeParent>
{
	...
	readonly onDidChangeTreeData: vscode.Event<TreeNodeParent | undefined> =
...
export class WorkItemNode extends TreeNodeParent {
	...
	constructor(workItemComposite: WorkItemComposite) {
		super(
			`${workItemComposite.workItemId} ${workItemComposite.workItemTitle}`,
		);
